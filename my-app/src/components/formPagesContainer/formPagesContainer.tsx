...
const FormPageContainer = (props:FormPageContainerProps) => {
  ...
  const {themeValue} = useThemeContext();
    ...
    return(
        <div className={classNames(style.container, {[style.darkContainer] : themeValue === Theme.Dark})}>
      <div className={classNames(style.text,{[style.darkText]: themeValue === Theme.Dark})}>Back to home</div>
      ...
      <div className={classNames(style.formContainer)}>
       ...
       <div className={classNames(style.additionalText, {[style.darkAdditionalText] : themeValue === Theme.Dark})}>
