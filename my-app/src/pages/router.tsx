    ...
    <Routes>
      <Route path={RoutesList.AllPosts} element={<Header />}>
        ...
        <Route
          ...
          element={
            isLoggedIn ? <SignUp /> : <Navigate to={RoutesList.AllPosts} />
          }
        />
        <Route
          path={RoutesList.SignIn}
          element={
            isLoggedIn ? <SignIn /> : <Navigate to={RoutesList.AllPosts} />
          }
        />
        <Route
          path={RoutesList.SelectedPost}
          element={
            !isLoggedIn ? <SelectedPost /> : <Navigate to={RoutesList.AllPosts} />
          }
        />
        <Route
          ...
          element={
            isLoggedIn ? (
              ...
              <Navigate to={RoutesList.AllPosts} />
            )
          }
        />
        <Route
