...
import postSlice, { PostSelectors, setSelectedPost, setSelectedPostModalOpened } from "../../../redux/reducers/postSlice"
 ...
 dispatch(setSelectedPost(null))
    ...
    return selectedPost ? (
        <Modal isOpened={isOpened} onClose={onCloseModal}>
          <PostCard size={PostCardSize.large} image={selectedPost.image} date={selectedPost.date} title={selectedPost.title}/>
        </Modal>
      ) : null;
    };
